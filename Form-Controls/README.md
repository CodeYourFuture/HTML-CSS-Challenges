...
1. What is the customer's name? I must collect this data, and validate it. But what is a valid name? I must decide something.
   ...
   -Split into first and last name. Make sure there are no numbers or special characters.

2. What is the customer's email? I must make sure the email is valid. Email addresses have a consistent pattern.

   -check email validity by ensuring there is one @ symbol. Look into other ways to validate the email

3. What colour should this t-shirt be? I must give three options. How will I make sure they don't pick other colours?

- Selection with only 3 options
